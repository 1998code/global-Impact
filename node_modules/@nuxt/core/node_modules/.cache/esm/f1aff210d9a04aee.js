let resolve,fsp,defu,template,addTemplates;_d9a‍.x([["default",()=>_d9a‍anonymous]]);_d9a‍.w("path",[["resolve",["resolve"],function(v){resolve=v}]]);_d9a‍.w("fs",[["promises",["fsp"],function(v){fsp=v}]]);_d9a‍.w("defu",[["default",["defu"],function(v){defu=v}]]);_d9a‍.w("lodash.template",[["default",["template"],function(v){template=v}]]);_d9a‍.w("./utils",[["addTemplates",["addTemplates"],function(v){addTemplates=v}]]);





               async function  _d9a‍anonymous(moduleOptions) {
  const defaults = {
    preference: 'system',
    fallback: 'light',
